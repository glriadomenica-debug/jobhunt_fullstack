...
function RecruiterLayout() {
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-slate-100">
      ...
      <header className="fixed top-0 left-0 right-0 h-16 bg-indigo-900 flex items-center justify-between px-4 md:hidden z-50">
        <h1 className="text-white text-xl font-bold">JobHunt</h1>
      ...
      <aside
        className={`fixed md:relative top-0 left-0 h-screen w-72
        bg-gradient-to-b from-slate-950 via-indigo-950 to-indigo-800
      ...
      >
        ...
        <div className="p-8 border-b border-white/10">
          <h1 className="text-3xl font-extrabold">JobHunt</h1>

          <p className="text-blue-200 mt-2 text-sm">Recruiter Portal</p>
        </div>
