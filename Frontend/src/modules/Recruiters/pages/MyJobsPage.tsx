      ...
      <div>
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className=" bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-5 py-3 rounded-xl shadow hover:shadow-lg transition"
          >
            + Create Job
          </button>
        </div>
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-slate-500 mt-2">📍 {job.location}</p>
                  ...
                  <p className="mt-3 text-sm text-slate-500">Requirements:</p>
              ...
              <div className="mt-5 flex gap-3">
                ...
                <button
                  ...
                  className="bg-rose-500 hover:bg-rose-600 text-white px-5 py-2 rounded-xl"
                >
                  Delete
                </button>
              </div>
